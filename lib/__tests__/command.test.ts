...
it('初始化指令', () => {
  ...
  const command1 = d.command('command1', ['field1', d.info.any('field2')])
  ...
  const command2 = d.command('command2', () => ['field1', d.info.any('field2')])
  ...
  const facadeCmd1 = d.facadeCmd('facadeCmd1', ['field1', d.info.any('field2')])
  ...
  const facadeCmd2 = d.facadeCmd('facadeCmd2', () => ['field1', d.info.any('field2')])
